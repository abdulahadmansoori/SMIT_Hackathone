                    ...
                    <div className="collapse navbar-collapse " id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mx-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" href="/home"><i class="bi bi-house-door-fill text-secondary"></i></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/cart"><i class="bi bi-cart-fill text-secondary"></i></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/account"><i class="bi bi-person-fill text-secondary"></i></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" onClick={logOutHandler}><i class="bi bi-box-arrow-right"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
